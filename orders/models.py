...
class Order(models.Model):
    ...
    customer_numbers = models.CharField(max_length=13, blank=True, null=True, default=None)
    ...
    def __str__(self):
        return  "Order %s %s" % (self.id, self.is_active.name)
...
def product_in_order_post_save(sender,  instance, created, **kwargs):
    ...
    all_products_in_order = ProductInOrder.objects.filter(order=order, is_activate=True)
    order_total_price = 0
